...
qthelp:
	...
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/HelloWorld.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/HelloWorld"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/HelloWorld"
	@echo "# devhelp"
